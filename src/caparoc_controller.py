...
class CaparocController:
    ...
    def _establish_implicit_messaging(self, driver, config_data=None):
        ...
        ⚠️ 目前未實作 - 因為 pycomm3 不支援帶 Configuration Data 的 Forward Open
        ...
        """
        print("\n⚠️ Implicit Messaging 目前未實作")
        print("   原因: pycomm3 不支援帶 Configuration Data 的 Forward Open")
        print("   狀態: 使用 Explicit Messaging (Parameter Object) 替代")
        return False
